...
public class Config {
     ...
     * @param inputAttribute The attribute that was imported (from the file). This will be the key.
     * @param exportAttribute The attribute that will be exported (to a JSON file). This will be the value.
     */
     ...
     * @param inputAttribute The attribute that was imported (from the file). This is the key.
     * @param exportAttribute The attribute that would have been exported. This is the value.
     */
