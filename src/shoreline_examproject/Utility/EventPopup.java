...
public class EventPopup {
    ...
    /**
     * Show an alert popup, using the message of the supplied exception as the message of the popup.
    ...
    /**
     * Show an information popup, using the message of the supplied exception as the message of the popup.
     * @param ex The supplied exception.
     */
